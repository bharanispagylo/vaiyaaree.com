                                                ...
                                                <td style="padding-bottom: 24px;">
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; font-family: Arial, sans-serif;">
                                                        <tr>
                                                            ...
                                                            <td style="padding: 4px 0; text-align: right; color: #1e293b; font-size: 14px; font-weight: 500;">Γé╣${subtotal.toLocaleString('en-IN')}</td>
                                                        </tr>
                                                        ${order.cgst ? `
                                                        <tr>
                                                            <td style="padding: 4px 0; color: #64748b; font-size: 14px;">CGST (2.5%):</td>
                                                            <td style="padding: 4px 0; text-align: right; color: #1e293b; font-size: 14px;">Γé╣${order.cgst.toLocaleString('en-IN')}</td>
                                                        </tr>` : ''}
                                                        ${order.sgst ? `
                                                        <tr>
                                                            <td style="padding: 4px 0; color: #64748b; font-size: 14px;">SGST (2.5%):</td>
                                                            <td style="padding: 4px 0; text-align: right; color: #1e293b; font-size: 14px;">Γé╣${order.sgst.toLocaleString('en-IN')}</td>
                                                        </tr>` : ''}
                                                        ${order.igst ? `
                                                        <tr>
                                                            <td style="padding: 4px 0; color: #64748b; font-size: 14px;">IGST (5%):</td>
                                                            <td style="padding: 4px 0; text-align: right; color: #1e293b; font-size: 14px;">Γé╣${order.igst.toLocaleString('en-IN')}</td>
                                                        </tr>` : ''}
                                                        <tr>
                                                            <td style="padding: 4px 0; color: #64748b; font-size: 14px;">Shipping:</td>
                                                            <td style="padding: 4px 0; text-align: right; color: #1e293b; font-size: 14px;">${shipping > 0 ? `Γé╣${shipping.toLocaleString('en-IN')}` : '<span style="color: #059669; font-weight: 600;">FREE</span>'}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 10px 0 4px 0; text-align: right; color: #059669; font-size: 18px; font-weight: 800;">Γé╣${(order.total_amount || 0).toLocaleString('en-IN')}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 24px;">
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; font-family: Arial, sans-serif;">
                                                        ...
                                                        <tr>
                                                            <td width="50%" style="padding: 8px 0 4px 0; color: #475569; font-size: 14px;"><strong>Total Amount:</strong> <span style="color: #059669; font-weight: 700;">Γé╣${(order.total_amount || 0).toLocaleString('en-IN')}</span></td>
                                                            <td width="50%" style="padding: 8px 0 4px 0; text-align: right; color: #475569; font-size: 14px;"><strong>Payment:</strong> <span style="color: #1e293b; font-weight: 600;">${order.payment_method || 'N/A'}</span></td>
                                                        </tr>
                                                    </table>
                                                </td>
