...
const DEFAULT_POLICIES = {
    'privacy-policy': {
        ...
        content: `
            ...
            <p>When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, phone number to help you with your experience.</p>
            ...
            <p>We do use an SSL certificate.</p>
            ...
            <ul style="padding-left: 1.5rem; margin-bottom: 1.5rem;">
                ...
                <li>You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser settings. Each browser is a little different, so look at your browser's help menu to learn the correct way to modify your cookies.</li>
    ...
    'return-policy': {
        title: 'Return Policy',
        content: `
            <p>Thank you for choosing <strong>Vaiyaaree</strong> for your saree purchase. We are committed to providing you with exquisite sarees and exceptional customer service. Please review our return policy carefully, as it outlines our procedures regarding non-returnable saree items.</p>

            <h2 style="font-size: 1.4rem; font-weight: 600; margin-top: 2rem; margin-bottom: 0.75rem; color: #111;">1. Non-Returnable Items</h2>
            <p>Due to the unique nature of sarees and for hygiene reasons, we do not accept returns or exchanges for sarees once they have been purchased and delivered.</p>
            <p>This policy applies to all sarees, including designer sarees, traditional sarees, silk sarees, and any other saree variations available for purchase on our website.</p>
            <p>We will accept returns if there is any damage or defect in the items.</p>

            <h2 style="font-size: 1.4rem; font-weight: 600; margin-top: 2rem; margin-bottom: 0.75rem; color: #111;">2. Quality Assurance</h2>
            <p>We take pride in the quality and craftsmanship of our sarees. Each saree undergoes thorough inspection before shipment to ensure that it meets our quality standards.</p>

            <h2 style="font-size: 1.4rem; font-weight: 600; margin-top: 2rem; margin-bottom: 0.75rem; color: #111;">3. Sizing and Descriptions</h2>
            <p>We strive to provide accurate sizing information and detailed descriptions for each saree listed on our website. Please review this information carefully before making your purchase to ensure that the saree meets your expectations.</p>
    ...
    'shipping-policy': {
        ...
        content: `
            ...
            <p>Domestic orders typically arrive within 3-7 business days from the date of shipment, depending on the destination.<br />
            International orders may take 7-21 business days to arrive, depending on the destination and customs processing times.<br />
            Please note that these are estimated shipping times and actual delivery may vary based on factors beyond our control, such as customs delays or unforeseen circumstances.</p>
            ...
            Customers can track their orders using the provided tracking number through the carrier's website.</p>
            ...
            <h2 style="font-size: 1.4rem; font-weight: 600; margin-top: 2rem; margin-bottom: 0.75rem; color: #111;">Shipping Insurance</h2>
            <p>Shipping insurance is available upon request for an additional fee.<br />
            Customers interested in purchasing shipping insurance should contact us prior to placing their order.</p>
            ...
            <h2 style="font-size: 1.4rem; font-weight: 600; margin-top: 2rem; margin-bottom: 0.75rem; color: #111;">Returns and Exchanges</h2>
    ...
    'terms-conditions': {
        ...
        content: `
            ...
            <p>The term 'Vaiyaaree' or 'us' or 'we' refers to the owner of www.vaiyaaree.com whose registered office is Coimbatore, Tamil Nadu. The term 'you' refers to the user or viewer of www.vaiyaaree.com.</p>
            ...
            <ul style="padding-left: 1.5rem; margin-bottom: 1.5rem;">
                ...
                <li style="margin-bottom: 0.5rem;">This website uses cookies to monitor browsing preferences. If you do allow cookies to be used, the following personal information may be stored by us for use by third parties: [email, mobile number, area].</li>
                ...
                <li style="margin-bottom: 0.5rem;">Your use of this website and any dispute arising out of such use of www.vaiyaaree.com is subject to the laws of India and the jurisdiction of Coimbatore, Tamil Nadu.</li>
            </ul>
        `
    },
    ...
    'refund-cancellation': {
        ...
        content: `
            <p><strong>Vaiyaaree</strong> reserves the right to cancel the received order, or delay the order because of insufficient quantity, national holidays, force-majeure events (like floods, earthquakes, political instability, strikes etc.)</p>

            <ul style="padding-left: 1.5rem; margin-bottom: 1.5rem;">
                <li style="margin-bottom: 0.5rem;">In case <strong>Vaiyaaree</strong> cancels an order, 100% refund will be paid to the customer.</li>
                <li style="margin-bottom: 0.5rem;">The order booked by the customer for the purchase of any our product/service shall not be cancelled by the customer for refund. Kindly note that the money is not transferred back to the buyer's credit/debit card.</li>
                <li style="margin-bottom: 0.5rem;">In case of cancellation of purchase of any of our product/services, the amount once received by <strong>Vaiyaaree</strong> will be adjusted against the next transaction only. This facility is valid up to 1 month from the date of cancellation of order.</li>
                ...
                <li style="margin-bottom: 0.5rem;"><strong>Vaiyaaree</strong> will not be liable to customer or to any other person for any direct, indirect, incidental, punitive or consequential loss, damage, cost or expense of any kind whatsoever and howsoever caused from out of the information derived by you through your usage of this site. In no event shall Vaiyaaree be liable for any direct, indirect, punitive, incidental, special, or consequential damages arising out of information provided on the website in so far as such information is derived from other service providers.</li>
            </ul>
    ...
    'disclaimer': {
        ...
        content: `
            ...
            <p>Through this website you are able to link to other websites which are not under the control of <strong>Vaiyaaree</strong>. We have no control over the nature, content and availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them.</p>

            <p>Every effort is made to keep the website up and running smoothly. However, <strong>Vaiyaaree</strong> takes no responsibility for, and will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.</p>
        `
    }
};
