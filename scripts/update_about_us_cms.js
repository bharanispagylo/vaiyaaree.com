...
async function updateAboutUs() {
    ...
    <div class="about-us-text">
        <p class="brand-tagline">A Castprintz company</p>
        <p>Cast Printz sarees aims at offering a fantastic blend of style, fashion, colours and quality. Our journey began with a simple idea – to create a platform where saree lovers could find the most exquisite and authentic collection of sarees from all over India.</p>
        ...
        <p>Cast Printz sarees grew as a well trusted brand, well-received by its 100K+ Instagram followers, stands a testimony.</p>
        ...
        <div class="sign-off">
            <p>Yours</p>
            <p class="sign-off-author">Cast Printz Sarees</p>
        </div>
    </div>
    <div class="about-us-media">
        <img src="/images/about-us-saree.jpg" alt="Cast Printz About Us Saree" class="about-image" />
    </div>
</div>`;
